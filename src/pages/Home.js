  ...
  return (
    <>
        <header className='w-full px-3 h-[100vh] flex flex-col justify-center items-center bg-[#fcde67]'>
            ...
            <button className='mt-10 w-2/3 md:w-1/3 bg-[#5bccf6] text-slate-900 font-semibold px-3 py-3 rounded-md drop-shadow-lg' onClick={()=>{navigate('/products')}}>Start Shopping</button>
            </div>
        </header>
    </> 
  )
